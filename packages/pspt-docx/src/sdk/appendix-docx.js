...
/**
 * =============================================================================
 *  APPENDIX (Part 14 of the Product Documentation Master — final part)
 * =============================================================================
 * Regenerates "Part 14. Appendix" exactly: title page, metadata table, an
 * italic guidance note, then a single Resource/Link zebra table with no
...
const DEFAULT_RESOURCES = [
  { resource: 'Timeline / Project tracker', link: '[Link]' },
  { resource: 'Design files (Figma)', link: '[Link]' },
  { resource: 'Full API reference (OpenAPI/Swagger)', link: '[Link]' },
  { resource: 'Data schema / ERD source', link: '[Link]' },
  { resource: 'Runbooks', link: '[Link]' },
  { resource: 'Research repository', link: '[Link]' },
  { resource: 'Analytics dashboard', link: '[Link]' },
...
const SECTION_GUIDE = [
  ...
  {
    method: 'setResources',
    purpose: 'Resource/Link table rows.',
    example: [{ resource: 'Design files (Figma)', link: 'https://figma.com/...' }],
  },
];
...
class AppendixSDK {
  ...
  _buildPartTitlePage() {
    return [new Paragraph({ heading: HeadingLevel.HEADING_1, children: [headingRun('Appendix')] })];
  }
  ...
  _buildContent() {
    ...
    children.push(
      guidanceNote('Link out to living/detailed resources instead of duplicating them here.'),
    );
    children.push(
      buildZebraTable(
        [
          { key: 'resource', header: 'Resource', weight: 1.3 },
          { key: 'link', header: 'Link', weight: 2.5 },
        ],
        this.data.resources && this.data.resources.length ? this.data.resources : DEFAULT_RESOURCES,
      ),
    );
      ...
      children: [
        new Paragraph({
          ...
          children: [
            ...
            run('Appendix', { bold: true, size: SIZE.headerFooter, color: COLOR.headerFooterText }),
