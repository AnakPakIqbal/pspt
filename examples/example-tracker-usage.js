...
async function main() {
  ...
  tracker.addSection({
    ...
    tasks: [
      ...
      {
        no: 14,
        name: 'AI Project Automate Creation',
        detail: '',
        checklist: 'Completed',
        mandays: 2,
        total: 2,
  ...
  tracker.addSection({
    ...
    tasks: [
      {
        no: 1,
        name: 'Redesign Organization Hierarchy (Design)',
        detail: '',
        checklist: 'Completed',
        mandays: 2,
        total: 2,
      ...
      {
        no: 2,
        name: 'Redesign Organization Hierarchy (Implementation)',
        detail: '',
        checklist: 'Completed',
        mandays: 2,
        total: 2,
      ...
      {
        no: 3,
        name: 'Enhanced AI Integration with Gemini 2.5',
        detail: '',
        checklist: 'Completed',
        mandays: 6,
        total: 6,
        ...
        endDate: '2026-08-03',
        deliverables: 'Gemini 2.5',
        notes: 'Spans July 29 to Aug 3',
        check: true,
      },
      {
        no: 4,
        name: 'Review and enhance security and code optimization',
        detail: '',
        checklist: 'Completed',
        mandays: 2,
        total: 2,
      ...
      {
        no: 5,
        name: 'Auto select project at task/subtask creation',
        detail: '',
        checklist: 'Completed',
        mandays: 1,
        total: 1,
